                    ...
                    <section className={`${sectionClasses.section} bg-white border-t-8 border-emerald-500`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                            ...
                            <div className={`${componentClasses.programCard} from-orange-50 to-red-50 border-orange-200`}>
                                ...
                                <h3 className="text-2xl font-bold text-gray-800 mb-4">Commercial Cooking NC III</h3>
                            ...
                            <div className={`${componentClasses.programCard} from-orange-50 to-red-50 border-orange-200`}>
                                ...
                                <div className={`${componentClasses.emoji} text-orange-500`}>👩‍🍳</div>
                                <h3 className="text-2xl font-bold text-gray-800 mb-4">Cookery NC II</h3>
                                <p className="text-gray-700 mb-6 leading-relaxed">
                                    Learn essential cooking skills for preparing and presenting hot and cold meals. 
                                    This course includes training in kitchen safety, sanitation, and proper food handling.
                                </p>
                                <ul className={componentClasses.featureList}>
                                    <li className="flex items-center">
                                        <svg className="w-4 h-4 text-emerald-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="text-center">
                            ...
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className={componentClasses.author}>
                                    ...
                                    <div className="text-gray-500 text-base mt-1">Commercial Cooking NC III Graduate, 2023</div>
                                </div>
                            </div>
                        </div>
                    </section>
